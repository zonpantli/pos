...
if(cljs.core.truth_((function (){var and__3546__auto____10214 = data;
...
{eval.call(null,data);
var G__10215__10216 = cljs.core.seq.call(null,cljs.core.deref.call(null,noir.cljs.client.watcher.callbacks));

if(cljs.core.truth_(G__10215__10216))
{var cur__10217 = cljs.core.first.call(null,G__10215__10216);
var G__10215__10218 = G__10215__10216;

while(true){
cur__10217.call(null,data);
var temp__3698__auto____10219 = cljs.core.next.call(null,G__10215__10218);

if(cljs.core.truth_(temp__3698__auto____10219))
{var G__10215__10220 = temp__3698__auto____10219;

{
var G__10221 = cljs.core.first.call(null,G__10215__10220);
var G__10222 = G__10215__10220;
cur__10217 = G__10221;
G__10215__10218 = G__10222;
continue;
}
} else
{}
...
var selector_button__delegate = function (p__10225,p__10226){
var map__10227__10229 = p__10225;
var map__10227__10230 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__10227__10229))?cljs.core.apply.call(null,cljs.core.hash_map,map__10227__10229):map__10227__10229);
var label__10231 = cljs.core.get.call(null,map__10227__10230,"\uFDD0'label");
var mode__10232 = cljs.core.get.call(null,map__10227__10230,"\uFDD0'mode");
var vec__10228__10233 = p__10226;
var m__10234 = cljs.core.nth.call(null,vec__10228__10233,0,null);

var elem__6198__auto____10236 = crate.core.html.call(null,(function (){var klass__10235 = cljs.core.str.call(null,"noir-cljs-button ",(cljs.core.truth_(cljs.core._EQ_.call(null,mode__10232,m__10234))?"active":null));

return cljs.core.PersistentVector.fromArray(["\uFDD0'li",crate.tags.link_to.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'class","\uFDD0'data-mode"],{"\uFDD0'class":klass__10235,"\uFDD0'data-mode":mode__10232}),"#",label__10231)]);
})());

elem__6198__auto____10236.setAttribute("crateGroup",group__6197__auto____10224);
return elem__6198__auto____10236;
};
var selector_button = function (p__10225,var_args){
var p__10226 = null;
if (goog.isDef(var_args)) {
  p__10226 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return selector_button__delegate.call(this, p__10225, p__10226);
};
selector_button.cljs$lang$maxFixedArity = 1;
selector_button.cljs$lang$applyTo = (function (arglist__10237){
var p__10225 = cljs.core.first(arglist__10237);
var p__10226 = cljs.core.rest(arglist__10237);
return selector_button__delegate.call(this, p__10225, p__10226);
});
...
var elem__6198__auto____10239 = crate.core.html.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.PersistentVector.fromArray(["\uFDD0'style",cljs.core.ObjMap.fromObject(["\uFDD0'type"],{"\uFDD0'type":"text/css"}),"#noir-cljs-selector {position:fixed; bottom:15px; right:30px; list-style:none; }\n     #noir-cljs-selector li {}\n     #noir-cljs-selector a { float:left; display:inline; text-decoration:none; line-height:1em; height:19px; padding:5px 10px; background:#77c; width:10px; border:1px solid #55c; text-align:center; border-radius:5px; margin-bottom:8px; color:#449; }\n     #noir-cljs-selector a:hover {background:#99f;}\n     #noir-cljs-selector .active {background:#7cc; border-color:#599;} "]),cljs.core.PersistentVector.fromArray(["\uFDD0'ul#noir-cljs-selector",cljs.core.map.call(null,(function (p1__10223_SHARP_){
return noir.cljs.client.watcher.selector_button.call(null,p1__10223_SHARP_,m);
}),noir.cljs.client.watcher.buttons)])]));

elem__6198__auto____10239.setAttribute("crateGroup",group__6197__auto____10238);
return elem__6198__auto____10239;
});
...
var $me__10241 = jayq.core.$.call(null,me__10240);
var mode__10242 = jayq.core.data.call(null,$me__10241,"\uFDD0'mode");

jayq.core.add_class.call(null,$me__10241,"\uFDD0'active");
return noir.cljs.client.watcher.set_mode.call(null,mode__10242);
}));
