...
if(cljs.core.truth_((function (){var and__3546__auto____9196 = data;
...
{eval.call(null,data);
var G__9197__9198 = cljs.core.seq.call(null,cljs.core.deref.call(null,noir.cljs.client.watcher.callbacks));

if(cljs.core.truth_(G__9197__9198))
{var cur__9199 = cljs.core.first.call(null,G__9197__9198);
var G__9197__9200 = G__9197__9198;

while(true){
cur__9199.call(null,data);
var temp__3698__auto____9201 = cljs.core.next.call(null,G__9197__9200);

if(cljs.core.truth_(temp__3698__auto____9201))
{var G__9197__9202 = temp__3698__auto____9201;

{
var G__9203 = cljs.core.first.call(null,G__9197__9202);
var G__9204 = G__9197__9202;
cur__9199 = G__9203;
G__9197__9200 = G__9204;
continue;
}
} else
{}
...
var selector_button__delegate = function (p__9207,p__9208){
var map__9209__9211 = p__9207;
var map__9209__9212 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__9209__9211))?cljs.core.apply.call(null,cljs.core.hash_map,map__9209__9211):map__9209__9211);
var label__9213 = cljs.core.get.call(null,map__9209__9212,"\uFDD0'label");
var mode__9214 = cljs.core.get.call(null,map__9209__9212,"\uFDD0'mode");
var vec__9210__9215 = p__9208;
var m__9216 = cljs.core.nth.call(null,vec__9210__9215,0,null);

var elem__5989__auto____9218 = crate.core.html.call(null,(function (){var klass__9217 = cljs.core.str.call(null,"noir-cljs-button ",(cljs.core.truth_(cljs.core._EQ_.call(null,mode__9214,m__9216))?"active":null));

return cljs.core.PersistentVector.fromArray(["\uFDD0'li",crate.tags.link_to.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'class","\uFDD0'data-mode"],{"\uFDD0'class":klass__9217,"\uFDD0'data-mode":mode__9214}),"#",label__9213)]);
})());

elem__5989__auto____9218.setAttribute("crateGroup",group__5988__auto____9206);
return elem__5989__auto____9218;
};
var selector_button = function (p__9207,var_args){
var p__9208 = null;
if (goog.isDef(var_args)) {
  p__9208 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return selector_button__delegate.call(this, p__9207, p__9208);
};
selector_button.cljs$lang$maxFixedArity = 1;
selector_button.cljs$lang$applyTo = (function (arglist__9219){
var p__9207 = cljs.core.first(arglist__9219);
var p__9208 = cljs.core.rest(arglist__9219);
return selector_button__delegate.call(this, p__9207, p__9208);
});
...
var elem__5989__auto____9221 = crate.core.html.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.PersistentVector.fromArray(["\uFDD0'style",cljs.core.ObjMap.fromObject(["\uFDD0'type"],{"\uFDD0'type":"text/css"}),"#noir-cljs-selector {position:fixed; bottom:15px; right:30px; list-style:none; }\n     #noir-cljs-selector li {}\n     #noir-cljs-selector a { float:left; display:inline; text-decoration:none; line-height:1em; height:19px; padding:5px 10px; background:#77c; width:10px; border:1px solid #55c; text-align:center; border-radius:5px; margin-bottom:8px; color:#449; }\n     #noir-cljs-selector a:hover {background:#99f;}\n     #noir-cljs-selector .active {background:#7cc; border-color:#599;} "]),cljs.core.PersistentVector.fromArray(["\uFDD0'ul#noir-cljs-selector",cljs.core.map.call(null,(function (p1__9205_SHARP_){
return noir.cljs.client.watcher.selector_button.call(null,p1__9205_SHARP_,m);
}),noir.cljs.client.watcher.buttons)])]));

elem__5989__auto____9221.setAttribute("crateGroup",group__5988__auto____9220);
return elem__5989__auto____9221;
});
...
var $me__9223 = jayq.core.$.call(null,me__9222);
var mode__9224 = jayq.core.data.call(null,$me__9223,"\uFDD0'mode");

jayq.core.add_class.call(null,$me__9223,"\uFDD0'active");
return noir.cljs.client.watcher.set_mode.call(null,mode__9224);
}));
