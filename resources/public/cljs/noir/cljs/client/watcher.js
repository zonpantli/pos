...
if(cljs.core.truth_((function (){var and__3546__auto____9774 = data;
...
{eval.call(null,data);
var G__9775__9776 = cljs.core.seq.call(null,cljs.core.deref.call(null,noir.cljs.client.watcher.callbacks));

if(cljs.core.truth_(G__9775__9776))
{var cur__9777 = cljs.core.first.call(null,G__9775__9776);
var G__9775__9778 = G__9775__9776;

while(true){
cur__9777.call(null,data);
var temp__3698__auto____9779 = cljs.core.next.call(null,G__9775__9778);

if(cljs.core.truth_(temp__3698__auto____9779))
{var G__9775__9780 = temp__3698__auto____9779;

{
var G__9781 = cljs.core.first.call(null,G__9775__9780);
var G__9782 = G__9775__9780;
cur__9777 = G__9781;
G__9775__9778 = G__9782;
continue;
}
} else
{}
...
var group__6008__auto____9784 = cljs.core.swap_BANG_.call(null,crate.core.group_id,cljs.core.inc);

/**
* @param {...*} var_args
*/
noir.cljs.client.watcher.selector_button = (function() { 
var selector_button__delegate = function (p__9785,p__9786){
var map__9787__9789 = p__9785;
var map__9787__9790 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__9787__9789))?cljs.core.apply.call(null,cljs.core.hash_map,map__9787__9789):map__9787__9789);
var label__9791 = cljs.core.get.call(null,map__9787__9790,"\uFDD0'label");
var mode__9792 = cljs.core.get.call(null,map__9787__9790,"\uFDD0'mode");
var vec__9788__9793 = p__9786;
var m__9794 = cljs.core.nth.call(null,vec__9788__9793,0,null);

var elem__6009__auto____9796 = crate.core.html.call(null,(function (){var klass__9795 = cljs.core.str.call(null,"noir-cljs-button ",(cljs.core.truth_(cljs.core._EQ_.call(null,mode__9792,m__9794))?"active":null));

return cljs.core.PersistentVector.fromArray(["\uFDD0'li",crate.tags.link_to.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'class","\uFDD0'data-mode"],{"\uFDD0'class":klass__9795,"\uFDD0'data-mode":mode__9792}),"#",label__9791)]);
})());

elem__6009__auto____9796.setAttribute("crateGroup",group__6008__auto____9784);
return elem__6009__auto____9796;
};
var selector_button = function (p__9785,var_args){
var p__9786 = null;
if (goog.isDef(var_args)) {
  p__9786 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return selector_button__delegate.call(this, p__9785, p__9786);
};
selector_button.cljs$lang$maxFixedArity = 1;
selector_button.cljs$lang$applyTo = (function (arglist__9797){
var p__9785 = cljs.core.first(arglist__9797);
var p__9786 = cljs.core.rest(arglist__9797);
return selector_button__delegate.call(this, p__9785, p__9786);
});
return selector_button;
})()
;
noir.cljs.client.watcher.selector_button.prototype._crateGroup = group__6008__auto____9784;
var group__6008__auto____9798 = cljs.core.swap_BANG_.call(null,crate.core.group_id,cljs.core.inc);

noir.cljs.client.watcher.selector = (function selector(m){
var elem__6009__auto____9799 = crate.core.html.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0'div",cljs.core.PersistentVector.fromArray(["\uFDD0'style",cljs.core.ObjMap.fromObject(["\uFDD0'type"],{"\uFDD0'type":"text/css"}),"#noir-cljs-selector {position:fixed; bottom:15px; right:30px; list-style:none; }\n     #noir-cljs-selector li {}\n     #noir-cljs-selector a { float:left; display:inline; text-decoration:none; line-height:1em; height:19px; padding:5px 10px; background:#77c; width:10px; border:1px solid #55c; text-align:center; border-radius:5px; margin-bottom:8px; color:#449; }\n     #noir-cljs-selector a:hover {background:#99f;}\n     #noir-cljs-selector .active {background:#7cc; border-color:#599;} "]),cljs.core.PersistentVector.fromArray(["\uFDD0'ul#noir-cljs-selector",cljs.core.map.call(null,(function (p1__9783_SHARP_){
return noir.cljs.client.watcher.selector_button.call(null,p1__9783_SHARP_,m);
}),noir.cljs.client.watcher.buttons)])]));

elem__6009__auto____9799.setAttribute("crateGroup",group__6008__auto____9798);
return elem__6009__auto____9799;
});
noir.cljs.client.watcher.selector.prototype._crateGroup = group__6008__auto____9798;
...
var $me__9801 = jayq.core.$.call(null,me__9800);
var mode__9802 = jayq.core.data.call(null,$me__9801,"\uFDD0'mode");

jayq.core.add_class.call(null,$me__9801,"\uFDD0'active");
return noir.cljs.client.watcher.set_mode.call(null,mode__9802);
}));
