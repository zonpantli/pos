...
if(cljs.core.truth_((function (){var or__3548__auto____8430 = ("\uFDD0'id".call(null,n) === null);
...
var G__8431__delegate = function (_){
...
var temp__3695__auto____8435 = pos.client.util.from_coll_by_id.call(null,cljs.core.deref.call(null,pos.client.model.basket),d);

if(cljs.core.truth_(temp__3695__auto____8435))
{var item__8436 = temp__3695__auto____8435;

var qty__8437 = "\uFDD0'qty".call(null,item__8436);

return cljs.core.swap_BANG_.call(null,pos.client.model.basket,(function (p1__8434_SHARP_,p2__8433_SHARP_){
return cljs.core.set.call(null,cljs.core.replace.call(null,cljs.core.HashMap.fromArrays([item__8436],[p2__8433_SHARP_]),p1__8434_SHARP_));
}),cljs.core.update_in.call(null,item__8436,cljs.core.PersistentVector.fromArray(["\uFDD0'qty"]),cljs.core.inc));
} else
{var item__8438 = pos.client.util.default_variant_of_item.call(null,pos.client.util.from_coll_by_id.call(null,"\uFDD0'items".call(null,cljs.core.deref.call(null,pos.client.model.data)),d));

return cljs.core.swap_BANG_.call(null,pos.client.model.basket,cljs.core.conj,cljs.core.merge.call(null,item__8438,cljs.core.ObjMap.fromObject(["\uFDD0'qty","\uFDD0'discount"],{"\uFDD0'qty":1,"\uFDD0'discount":0})));
}
}));
lib.dispatch.react_to.call(null,cljs.core.set(["\uFDD0'basket-remove"]),(function (_,d){
var item__8439 = pos.client.util.from_coll_by_id.call(null,cljs.core.deref.call(null,pos.client.model.basket),d);

return cljs.core.swap_BANG_.call(null,pos.client.model.basket,cljs.core.disj,item__8439);
}));
