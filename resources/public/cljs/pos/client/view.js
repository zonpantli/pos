...
var value = null;
var value__7245 = (function (el){
return el.attr("value");
});
var value__7246 = (function (el,val){
return el.attr("value",val);
});
value = function(el,val){
switch(arguments.length){
case  1 :
return value__7245.call(this,el);
case  2 :
return value__7246.call(this,el,val);
}
...
return cljs.core.map.call(null,(function (p1__7248_SHARP_){
return cljs.core.merge.call(null,p1__7248_SHARP_,cljs.core.ObjMap.fromObject(["\uFDD0'value"],{"\uFDD0'value":"\uFDD0'name".call(null,p1__7248_SHARP_)}));
...
pos.client.view.render_customer = (function (){var method_table__3162__auto____7249 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var prefer_table__3163__auto____7250 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var method_cache__3164__auto____7251 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var cached_hierarchy__3165__auto____7252 = cljs.core.atom.call(null,cljs.core.ObjMap.fromObject([],{}));
var hierarchy__3166__auto____7253 = cljs.core.get.call(null,cljs.core.ObjMap.fromObject([],{}),"\uFDD0'hierarchy",cljs.core.global_hierarchy);

return (new cljs.core.MultiFn("render-customer","\uFDD0'event","\uFDD0'default",hierarchy__3166__auto____7253,method_table__3162__auto____7249,prefer_table__3163__auto____7250,method_cache__3164__auto____7251,cached_hierarchy__3165__auto____7252));
})();
cljs.core._add_method.call(null,pos.client.view.render_customer,"\uFDD0'customer-selected",(function (p__7254){
var map__7255__7256 = p__7254;
var map__7255__7257 = (cljs.core.truth_(cljs.core.seq_QMARK_.call(null,map__7255__7256))?cljs.core.apply.call(null,cljs.core.hash_map,map__7255__7256):map__7255__7256);
var id__7258 = cljs.core.get.call(null,map__7255__7257,"\uFDD0'id");

var customers__7259 = "\uFDD0'customers".call(null,cljs.core.deref.call(null,pos.client.model.data));
var customer__7260 = cljs.core.rand_nth.call(null,customers__7259);
var el__7261 = jayq.core.$.call(null,"\uFDD0'#customer-dropdown");

pos.client.view.value.call(null,el__7261,"\uFDD0'name".call(null,customer__7260));
pos.client.animation.flash_input_border.call(null,el__7261);
return pos.client.animation.slide_in_customer_icon.call(null,"\uFDD0'image".call(null,customer__7260));
}));
cljs.core._add_method.call(null,pos.client.view.render_customer,"\uFDD0'customer-deselected",(function (_){
var el__7262 = jayq.core.$.call(null,"\uFDD0'#customer-dropdown");

pos.client.view.value.call(null,el__7262,null);
return pos.client.view.reset_customer_icon.call(null);
}));
lib.dispatch.react_to.call(null,cljs.core.set(["\uFDD0'customer-change"]),(function (t,d){
var temp__3695__auto____7263 = "\uFDD0'id".call(null,d);

if(cljs.core.truth_(temp__3695__auto____7263))
{var id__7264 = temp__3695__auto____7263;
